package com.bank.islamic.ifsbregulatoryreporting.model;
...
/**
 * The BIAN control record for this service domain: "IFSB Regulatory Report Procedure".
 *
 ...
 * to its asset type (IFSB Regulatory Report). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "IFSB Regulatory Report Procedure";
